...
jQuery(document).ready(function() {
  ...
  processArguments().then(function(model) {
    ...
    // Set XTK event overrides in m.xtk_event_overrides
    ren3d.camera.zoomIn = zoomIn;
    ren3d.camera.zoomOut = zoomOut;
    ren3d.onShowtime = onShowtime;
    ren3d.onRender = onRender;
...
function initRenderer() {
  ...
  // http://stackoverflow.com/questions/10380269/change-the-config-attribute-of-an-interactor-for-disabling-some-user-events?rq=1
...
function preloadLandmarks(landmarks)
{
